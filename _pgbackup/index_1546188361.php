...
<html lang="en">
    ...
    <body class="text-center">
        <form class="form-signin" action="login.php" method="post">
            ...
            <input type="email" id="userID" class="form-control" placeholder="Username" autofocus="" required data-pg-name="userID">
            <label for="inputPassword" class="sr-only">Password</label>
            <input type="password" id="userPW" class="form-control" placeholder="Password" required data-pg-name="userPW">
